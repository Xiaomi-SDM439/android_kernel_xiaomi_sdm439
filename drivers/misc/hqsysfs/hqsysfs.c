...
struct pcba_info pcba[] = {
	...
	{PCBA_OLIVE_P0_1_INDIA, "PCBA_OLIVE_P0_1_INDIA"},
	{PCBA_OLIVE_P1_CN, "PCBA_OLIVE_P1_CN"},
	{PCBA_OLIVE_P1_GLOBAL_B28, "PCBA_OLIVE_P1_GLOBAL_B28"},
	{PCBA_OLIVE_P1_INDIA, "PCBA_OLIVE_P1_INDIA"},
	{PCBA_OLIVE_P1_1_GLOBAL, "PCBA_OLIVE_P1_1_GLOBAL"},
	{PCBA_OLIVE_P1_1_GLOBAL_B28, "PCBA_OLIVE_P1_1_GLOBAL_B28"},
	{PCBA_OLIVE_P1_1_INDIA, "PCBA_OLIVE_P1_1_INDIA"},
	{PCBA_OLIVE_P2_CN, "PCBA_OLIVE_P2_CN"},
	{PCBA_OLIVE_P2_GLOBAL, "PCBA_OLIVE_P2_GLOBAL"},
	{PCBA_OLIVE_P2_GLOBAL_B28, "PCBA_OLIVE_P2_GLOBAL_B28"},
	{PCBA_OLIVE_P2_INDIA, "PCBA_OLIVE_P2_INDIA"},
	{PCBA_OLIVE_P2_1_INDIA, "PCBA_OLIVE_P2_1_INDIA"},
	{PCBA_OLIVE_MP_CN, "PCBA_OLIVE_MP_CN"},
	{PCBA_OLIVE_MP_GLOBAL, "PCBA_OLIVE_MP_GLOBAL"},
	{PCBA_OLIVE_MP_GLOBAL_B28, "PCBA_OLIVE_MP_GLOBAL_B28"},
	{PCBA_OLIVE_MP_INDIA, "PCBA_OLIVE_MP_INDIA"},
	{PCBA_PINE_P0_CN, "PCBA_PINE_P0_CN"},
	{PCBA_PINE_P0_GLOBAL, "PCBA_PINE_P0_GLOBAL"},
	{PCBA_PINE_P1_GLOBALNB28, "PCBA_PINE_P1_GLOBALNB28"},
	{PCBA_PINE_P1_GLOBALB28, "PCBA_PINE_P1_GLOBALB28"},
	{PCBA_PINE_P1_CN, "PCBA_PINE_P1_CN"},
	{PCBA_PINE_P1_INDIA, "PCBA_PINE_P1_INDIA"},
	{PCBA_PINE_P1_1_INDIA, "PCBA_PINE_P1_1_INDIA"},
	{PCBA_PINE_P1_1_GLOBALB28, "PCBA_PINE_P1_1_GLOBALB28"},
	{PCBA_PINE_P2_GLOBALNB28, "PCBA_PINE_P2_GLOBALNB28"},
	{PCBA_PINE_P2_GLOBALB28, "PCBA_PINE_P2_GLOBALB28"},
	{PCBA_PINE_P2_CN, "PCBA_PINE_P2_CN"},
	{PCBA_PINE_P2_INDIA, "PCBA_PINE_P2_INDIA"},
	{PCBA_PINE_P2_MOBILE, "PCBA_PINE_P2_MOBILE"},
	{PCBA_PINE_MP_GLOBALNB28, "PCBA_PINE_MP_GLOBALNB28"},
	{PCBA_PINE_MP_GLOBALB28, "PCBA_PINE_MP_GLOBALB28"},
	{PCBA_PINE_MP_CN, "PCBA_PINE_MP_CN"},
	{PCBA_PINE_MP_INDIA, "PCBA_PINE_MP_INDIA"},
	{PCBA_PINE_MP_MOBILE, "PCBA_PINE_MP_MOBILE"},
	{PCBA_OLIVELITE_P0_1_CN, "PCBA_OLIVELITE_P0_1_CN"},
	{PCBA_OLIVELITE_P1_CN, "PCBA_OLIVELITE_P1_CN"},
	{PCBA_OLIVELITE_P1_GLOBAL_B28, "PCBA_OLIVELITE_P1_GLOBAL_B28"},
	{PCBA_OLIVELITE_P1_INDIA, "PCBA_OLIVELITE_P1_INDIA"},
	{PCBA_OLIVELITE_P1_1_GLOBAL, "PCBA_OLIVELITE_P1_1_GLOBAL"},
	{PCBA_OLIVELITE_P1_1_GLOBAL_B28, "PCBA_OLIVELITE_P1_1_GLOBAL_B28"},
	{PCBA_OLIVELITE_P1_1_INDIA, "PCBA_OLIVELITE_P1_1_INDIA"},
	{PCBA_OLIVELITE_P2_CN, "PCBA_OLIVELITE_P2_CN"},
	{PCBA_OLIVELITE_P2_GLOBAL, "PCBA_OLIVELITE_P2_GLOBAL"},
	{PCBA_OLIVELITE_P2_GLOBAL_B28, "PCBA_OLIVELITE_P2_GLOBAL_B28"},
	{PCBA_OLIVELITE_P2_INDIA, "PCBA_OLIVELITE_P2_INDIA"},
	{PCBA_OLIVELITE_P2_1_CN_PUBLIC, "PCBA_OLIVELITE_P2_1_CN_PUBLIC"},
	{PCBA_OLIVELITE_P2_1_CN, "PCBA_OLIVELITE_P2_1_CN"},
	{PCBA_OLIVELITE_MP_CN, "PCBA_OLIVELITE_MP_CN"},
	...
	if (HWID_VER == hw->hw_id) {
		...
		while (attr) {
			...
			if (curent_hw->hw_exist && (NULL != curent_hw->hw_device_name)) {
				count += snprintf(buf+count, SNPRINTF_MAXLEN, "%s: %s\n", curent_hw->attr.name, curent_hw->hw_device_name);
			}
		}
		...
		if (0 == hw->hw_exist) {
			count = snprintf(buf, SNPRINTF_MAXLEN, "Not support\n");
		} else if (NULL == hw->hw_device_name) {
			count = snprintf(buf, SNPRINTF_MAXLEN, "Installed with no device Name\n");
		} else {
			count = snprintf(buf, SNPRINTF_MAXLEN, "%s\n", hw->hw_device_name);
		}
	}
